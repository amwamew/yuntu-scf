    ...
    <el-table :data="tableData"
      ...
      <el-table-column label="操作"
        ...
        <template slot-scope="scope">
          <!-- scope.row -->
          <el-button type="text"
            size="small">接货明细</el-button>
          <el-button type="text"
            size="small">接货通知</el-button>
        </template>
      </el-table-column>
    </el-table>
    <div id="paging">
...
import { getReceivingNotice } from '@/api/bussiness/receiving-manage/index'
...
export default {
  ...
  created() {
    this._getReceivingNotice()
  },
  methods: {
    _getReceivingNotice() {
      getReceivingNotice().then(res => {
