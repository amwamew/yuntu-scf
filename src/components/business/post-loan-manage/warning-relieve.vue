...
import { getWarningRelieve } from '@/api/bussiness/post-loan-manage/index'
...
export default {
  ...
  created() {
    this._getWarningRelieve()
  },
  mounted() {},
  methods: {
    _getWarningRelieve() {
      getWarningRelieve(this.searchData).then(res => {
