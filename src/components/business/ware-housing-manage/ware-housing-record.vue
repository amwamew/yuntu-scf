...
import { getWareHousingRecord } from '@/api/bussiness/ware-housing-manage/index'
...
export default {
  ...
  created() {
    this._getWareHousingRecord()
  },
  methods: {
    _getWareHousingRecord() {
      getWareHousingRecord().then(res => {
