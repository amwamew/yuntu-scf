...
import { getWareHousingRegister } from '@/api/bussiness/ware-housing-manage/index'
...
export default {
  ...
  created() {
    this._getWareHousingRegister()
  },
  methods: {
    _getWareHousingRegister() {
      getWareHousingRegister().then(res => {
